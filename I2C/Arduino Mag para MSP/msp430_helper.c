...
void configurarMagnetometro(int MA, float DO, int MS, int GN, int MD){
  ...
  case 3: //CONFIGURAR NÚMERO DE AMOSTRAS PARA MÉDIA
        ...
        //if(DO == 0.75);                        // xxx000xx
          ...
          //MODO DE MEDIÇÃO (NORMAL, self test positivo, self test negativo)
  ...
  case 9: //CONFIGURAR MODO DE OPERAÇÃO (continuous, single, idle)
        //if(MD == 0);                  // xxxxxx00
